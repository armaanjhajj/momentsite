    ...
    <div className="relative h-[360px] bg-[#0f1216] rounded-2xl border border-neutral-800 p-3 text-white">
      {!created ? (
        <div className="space-y-2">
          ...
          <input className="w-full rounded-lg bg-black/40 border border-neutral-800 px-3 py-2 text-sm" placeholder="Study session @ Library" />
          <div className="grid grid-cols-2 gap-2">
            <input className="rounded-lg bg-black/40 border border-neutral-800 px-3 py-2 text-sm" placeholder="Today 5:45 PM" />
            <input className="rounded-lg bg-black/40 border border-neutral-800 px-3 py-2 text-sm" placeholder="Business Building" />
          </div>
        ...
        <div>
          ...
          <div className="rounded-xl bg-black/60 border border-neutral-800 p-4">
