...
function PhoneDemo() {
  ...
  const criteriaSets = [
       { name: 'Alex',     traits: ['marketing major', 'huge Drake fan'],      year: 'Sophomore' },
      { name: 'Sophia',   traits: ['valorant grinder', 'loves boba'],         year: 'Freshman'  },
      { name: 'Ethan',    traits: ['matcha enthusiast', 'into fitness'],      year: 'Senior'    },
      { name: 'Riya',     traits: ['loves gardening', 'book club regular'],   year: 'Junior'    },
      { name: 'Daniel',   traits: ['computer science major', 'tech enthusiast'], year: 'Freshman'  },
      { name: 'Amir',     traits: ['league player', 'poke bowl addict'],      year: 'Sophomore' },
      { name: 'Simeon',   traits: ['vintage thrifter', 'singer-songwriter'],   year: 'Junior'    },
      { name: 'Armaan',   traits: ['long-distance runner', 'fashion-forward'],  year: 'Senior'    },
      { name: 'Natasha',  traits: ['pre-med', 'Taylor Swift fan'],             year: 'Junior'    },
      { name: 'Owen',     traits: ['basketball lover', 'music festival goer'], year: 'Freshman'  },
      { name: 'Maya',     traits: ['coffee enthusiast', 'adventurous foodie'], year: 'Sophomore' },
      { name: 'Charlotte',traits: ['loves social events', 'digital creator'],    year: 'Senior'    },
