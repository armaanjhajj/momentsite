    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="container pt-12 pb-12 md:pt-16 md:pb-16">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-neutral-800 text-xs text-white/60 mb-6">
      ...
      <section className="container pb-12">
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-3 gap-4">
            <div className="rounded-2xl border border-neutral-800 bg-white/5 backdrop-blur p-6 text-center">
      ...
      {!authenticatedChapter && (
        <section className="container pb-12">
          <div className="max-w-2xl mx-auto">
            <div className="rounded-2xl border border-neutral-800 bg-white/5 backdrop-blur p-6 md:p-8">
              ...
              <form onSubmit={handleCodeSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-black/50 border border-neutral-800 rounded-lg text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-white/20"
              ...
              <form onSubmit={handleRSVPSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-center gap-3 p-4 border border-neutral-800 rounded-lg cursor-pointer hover:bg-white/5 transition-colors">
                      <input
                        type="radio"
                        name="rsvpStatus"
                        value="attending"
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-3 border border-neutral-800 rounded-lg hover:bg-white/5 transition-colors"
                  >
                    Change Chapter
                  </button>
                </div>
              ...
              {chapters.filter(c => c.type === 'fraternity').map((chapter) => {
                ...
                return (
                  <div
                    ...
                    className="rounded-lg border border-neutral-800 bg-white/5 p-4 hover:bg-white/10 transition-colors relative"
                  >
      ...
      <section className="container pb-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="rounded-2xl border border-neutral-800 bg-white/5 overflow-hidden">
      ...
      <section className="container pb-16">
        <div className="max-w-3xl mx-auto text-center">
          <div className="rounded-lg border border-neutral-800 bg-white/5 p-6">
