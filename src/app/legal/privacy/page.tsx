      ...
      <article className="max-w-4xl mx-auto prose prose-invert prose-lg">
        ...
        <div className="bg-neutral-800/80 border border-white/20 rounded-lg p-6 mb-8">
          ...
          <p className="text-lg text-white/90 leading-relaxed">
            IF YOU HAVE ANY QUESTIONS REGARDING THIS PRIVACY POLICY, PLEASE SEND US AN EMAIL AT PRIVACY@HAVEMOMENTS.COM
          </p>
        </div>
        ...
        <h2 className="text-3xl font-bold text-white mb-6">2. WHAT INFORMATION DO WE COLLECT?</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">a. Geolocation and Equipment Information</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">b. Financial Information</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">c. Google Calendar Data</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">3. HOW DO WE COLLECT INFORMATION?</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-4">We collect personal information from you in the following ways:</p>
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
          ...
          <li>• From third parties including Posthog as well as the Google Calendar API through the calendar.readonly scope to analyze your meeting patterns, attendee data, and event frequency from the past 12 months and upcoming month to identify your closest professional contacts.</li>
        </ul>
        
        <p className="text-lg text-white/90 leading-relaxed mb-4">We collect information from you automatically when you navigate through our Website, App, or Platform in the following ways:</p>
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
          <li>• Usage details;</li>
          <li>• IP addresses;</li>
        ...
        <h2 className="text-3xl font-bold text-white mb-6">4. HOW DO WE USE YOUR INFORMATION?</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-4">We use the information that you provide to:</p>
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
          <li>• Personalize your experience in using our Platform;</li>
          <li>• Provide you with information or services requested from us; and as a social media Platform, other Users are able to view your username and associated PII, and information you upload in the group chat features of the Platform</li>
          ...
          <li>• Enable the display of advertisements to our advertisers&apos; target audiences, although personal information is not shared with advertisers without your consent; and</li>
          <li>• Send you periodic emails, in accordance with the CAN-SPAM Act of 2003 as detailed in Section 16, via the email address provided by you to (i) send information, respond to inquiries, and/or other requests or questions; (ii) process orders and send information and updates pertaining to such orders; (iii) send additional information related to your product and/or service; and (iv) market to our mailing list or continue to send email to you after the original transaction has occurred.</li>
          <li>• Analyze Google Calendar data to identify your top 100 closest contacts based on meeting frequency, duration, and co-attendance patterns to facilitate meaningful professional connections and networking opportunities.</li>
        </ul>

        <h2 className="text-3xl font-bold text-white mb-6">5. OUR COOKIE POLICY</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">6. HOW DO WE PROTECT INFORMATION WE COLLECT?</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">7. DATA SECURITY MEASURES</h2>
        <h3 className="text-2xl font-semibold text-white mb-4">a. Security Measures</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">b. Fair Information Practice Principles</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">8. DISCLOSURE OF PERSONAL INFORMATION</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">Disclosure of Personal Information.</h3>
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">Other Disclosure of Personal Information.</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">Third Party Disclosure.</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">Choices Users Have About How Moments Uses and Discloses Information.</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-4">
          <strong>Tracking Technologies and Advertising.</strong> You can set their browser to refuse some or all the browser cookies, but if you disable or refuse cookies, some parts of our Website may not be accessible or function properly.
        </p>
        <p className="text-lg text-white/90 leading-relaxed mb-4">
          <strong>Disclosure of Users&apos; Information for Third-Party Advertising.</strong> Users can opt-out by (i) checking the relevant form when we collect the data; (ii) logging into the Website, App, or Platform and adjusting their preferences in their account profile by checking or unchecking the relevant boxes, or (iii) emailing us their opt-out request at privacy@havemoments.com. Users receiving promotional email can opt-out by sending a return email requesting to be omitted from future promotional email distributions. This opt-out will not apply to information provided by Moments for product purchases, warranty registration, or other transactions.
        </p>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
          <strong>Disclosure of User&apos;s Information for Targeted Advertising.</strong> Users can opt-out by (i) checking the relevant form when we collect the data, (ii) logging into the Website, App, or Platform and adjusting their preferences in their account profile by checking or unchecking the relevant boxes, or (iii) emailing us their opt-out request at privacy@havemoments.com.
        </p>

        <h2 className="text-3xl font-bold text-white mb-6">9. GOOGLE CALENDAR DATA PROTECTION</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
          <li>• <strong>Data Collection Scope:</strong> We access calendar events from the past year and one month in the future</li>
          <li>• <strong>Data Usage:</strong> We analyze event duration, attendee count, and attendee contact information to determine your top 100 closest professional contacts</li>
          <li>• <strong>Data Retention:</strong> Calendar data is stored for 3 days beyond the time necessary for analysis</li>
          <li>• <strong>Data Protection:</strong> Calendar data is processed in real-time and is not used for any purpose other than improving your networking experience on our Platform</li>
          <li>• <strong>Third-Party Sharing:</strong> We do not share, sell, or transfer any Google Calendar data to third parties</li>
          <li>• <strong>User Control:</strong> You can revoke calendar access at any time through your Google account settings</li>
        </ul>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <p className="text-lg text-white/90 leading-relaxed mb-6">
          <strong>GOOGLE CALENDAR DATA SHARING:</strong> We do not sell, transfer, or disclose Google Calendar user data to third parties. Calendar data is used exclusively for determining your closest professional network to improve matching functionality. We do not share attendee information, meeting details, or calendar patterns with other users or external parties.
        </p>

        <h2 className="text-3xl font-bold text-white mb-6">10. DATA RETENTION</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">11. AI PROCESSING AND PROFILING</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <ul className="text-lg text-white/90 leading-relaxed mb-6 space-y-2">
          <li>• <strong>Data Protection:</strong> Raw personal communications and calendar content are never used as training data for our machine learning models</li>
          <li>• <strong>Output Monitoring:</strong> All AI-generated recommendations and matches undergo quality assurance to prevent bias and ensure accuracy</li>
          <li>• <strong>Human Oversight:</strong> Critical decisions affecting user accounts, billing, or legal matters require human review and approval</li>
          <li>• <strong>Regular Audits:</strong> We conduct periodic assessments of our AI systems to identify and correct potential biases or inaccuracies</li>
        ...
        <h2 className="text-3xl font-bold text-white mb-6">12. FOR OUR CANADIAN USERS</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">a. Definition of Personal Information</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">b. Right to Access Personal Information</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">c. Right to Correction/Limited Right to Deletion</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">d. Right to be Forgotten</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">e. Data Breach Notification</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">f. Canadian Privacy Officer</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h3 className="text-2xl font-semibold text-white mb-4">g. Two Factor Authentication</h3>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <p className="text-lg text-white/90 leading-relaxed mb-6">
          <strong>IF YOU ARE UNDER 13, PLEASE DO NOT ACCESS OR USE OUR WEBSITE, APP, OR PLATFORM.</strong>
        </p>

        <h2 className="text-3xl font-bold text-white mb-6">15. FOR OUR NEW YORK USERS</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">16. OTHER US STATE PRIVACY LAWS</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">17. FOR OUR EUROPEAN CUSTOMERS</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">18. CAN-SPAM ACT OF 2003</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">19. MODIFICATIONS TO OUR PRIVACY POLICY</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <h2 className="text-3xl font-bold text-white mb-6">20. LIST OF THIRD-PARTY SERVICE PROVIDERS</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full border-collapse border border-white/20">
            ...
            <tbody>
              <tr>
                <td className="border border-white/20 p-4 text-white/90">MongoDB</td>
                <td className="border border-white/20 p-4 text-white/90">
                  <a href="https://www.mongodb.com/legal/privacy/privacy-policy" className="text-blue-400 hover:text-blue-300">https://www.mongodb.com/legal/privacy/privacy-policy</a><br />
                  1633 Broadway, New York, NY 10019, US
                </td>
              </tr>
              <tr>
                <td className="border border-white/20 p-4 text-white/90">PostHog, Inc.</td>
                <td className="border border-white/20 p-4 text-white/90">
                  <a href="https://posthog.com/privacy" className="text-blue-400 hover:text-blue-300">https://posthog.com/privacy</a><br />
        ...
        <h2 className="text-3xl font-bold text-white mb-6">21. COPYRIGHT INFRINGEMENT NOTICE</h2>
        <p className="text-lg text-white/90 leading-relaxed mb-6">
