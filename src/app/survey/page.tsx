  ...
  return (
    <main>
      <section className="container pt-10 pb-16 md:pt-14">
        <div className="mx-auto max-w-4xl rounded-2xl border border-white/10 bg-white overflow-hidden">
          <iframe
            data-tally-src="https://tally.so/embed/wa70BX?alignLeft=1&hideTitle=1&dynamicHeight=1"
            loading="lazy"
            width="100%"
            height="714"
            frameBorder={0}
